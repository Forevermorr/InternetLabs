...
<body>
   ...
   <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Новый клиент</li>
    </ol>
    </nav>
    <h1>Добавить клиента</h1>
        ...
        <form action="" class="flex flex-wrap">
            ...
            <input style='width: 288px; margin-bottom: 15px' class="form-control" type="text" name="name" placeholder="Введите цель займа">
			<a style='margin-left: 14px'>Сумма займа:</a>
            <input style='width: 288px; margin-bottom: 15px' class="form-control" type="text" name="cost" placeholder="Введите сумму займа">
			<a style='margin-left: 14px'>Комментарий менеджера:</a>
            <input style='width: 288px; margin-bottom: 15px' class="form-control" type="text" name="des" placeholder="Введите комментарий менеджера">
