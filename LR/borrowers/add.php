...
<body>
   ...
   <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Новый заемщик</li>
    </ol>
    </nav>
    <h1>Добавить заемщика</h1>
        <div class="alert alert-danger" role="alert" id="errorR" style="display: none">
            Ошибка
        </div>
        <form action="" class="d-flex">
            <input style='width: 288px;' class="form-control" type="text" name="name" placeholder="ФИО заемщика">
